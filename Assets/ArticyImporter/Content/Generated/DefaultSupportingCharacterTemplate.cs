...
namespace Articy._8_Bit_Tutorial_1_
{
    ...
    public class DefaultSupportingCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy._8_Bit_Tutorial_1_.Templates.DefaultSupportingCharacterTemplateTemplateConstraint mConstraints = new Articy._8_Bit_Tutorial_1_.Templates.DefaultSupportingCharacterTemplateTemplateConstraint();
        
        public Articy._8_Bit_Tutorial_1_.Templates.DefaultSupportingCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy._8_Bit_Tutorial_1_.Templates.DefaultSupportingCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy._8_Bit_Tutorial_1_.Templates.DefaultSupportingCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
