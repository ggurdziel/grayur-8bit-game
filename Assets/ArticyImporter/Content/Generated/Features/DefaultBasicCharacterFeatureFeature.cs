...
namespace Articy._8_Bit_Tutorial_1_.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy._8_Bit_Tutorial_1_.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy._8_Bit_Tutorial_1_.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy._8_Bit_Tutorial_1_.Features.DefaultBasicCharacterFeatureFeature clone = new Articy._8_Bit_Tutorial_1_.Features.DefaultBasicCharacterFeatureFeature();
