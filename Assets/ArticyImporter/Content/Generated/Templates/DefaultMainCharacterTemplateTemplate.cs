...
namespace Articy._8_Bit_Tutorial_1_.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy._8_Bit_Tutorial_1_.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        public Articy._8_Bit_Tutorial_1_.Features.DefaultBasicCharacterFeatureFeature DefaultBasicCharacterFeature
        {
            get
            {
        ...
        {
            Articy._8_Bit_Tutorial_1_.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy._8_Bit_Tutorial_1_.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy._8_Bit_Tutorial_1_.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
            if ((DefaultBasicCharacterFeature != null))
            {
                newClone.DefaultBasicCharacterFeature = ((Articy._8_Bit_Tutorial_1_.Features.DefaultBasicCharacterFeatureFeature)(DefaultBasicCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy._8_Bit_Tutorial_1_.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy._8_Bit_Tutorial_1_.Templates.DefaultMainCharacterTemplateTemplate();
