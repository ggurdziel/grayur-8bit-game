...
namespace Articy._8_Bit_Tutorial_1_
{
    ...
    public class DefaultMainCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultExtendedCharacterFeature, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy._8_Bit_Tutorial_1_.Templates.DefaultMainCharacterTemplateTemplateConstraint mConstraints = new Articy._8_Bit_Tutorial_1_.Templates.DefaultMainCharacterTemplateTemplateConstraint();
        
        public Articy._8_Bit_Tutorial_1_.Templates.DefaultMainCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy._8_Bit_Tutorial_1_.Templates.DefaultMainCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy._8_Bit_Tutorial_1_.Templates.DefaultMainCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
